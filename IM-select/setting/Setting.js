...
define([
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    selectionMode: '',
    allowExport: false,
    //Rogerio J. Sánchez - 20/07/2018
      //Opciones de configuración custom
    destroyHiddenLayersFromList: false,
    ...
    postCreate: function() {
      ...
      //Rogerio J. Sánchez - 20/07/2018
      //Opciones de configuración custom
      this.destroyHiddenLayersFromListCheckBox = new CheckBox({
        label: this.nls.hideInvisibleLayers,
        checked: this.config && this.config.destroyHiddenLayersFromList,
        onChange: lang.hitch(this, this._onDestroyHiddenLayersFromListChange)
      }, this.destroyHiddenLayersFromListCheckBoxDiv);

      this.selectAllOnOpenCheckBox = new CheckBox({
        label: this.nls.selectAllOnOpen,
        checked: this.config && this.config.selectAllOnOpen,
        onChange: lang.hitch(this, this._onSelectAllOnOpenChange)
      }, this.selectAllOnOpenCheckBoxDiv);
    ...
    _onDestroyHiddenLayersFromListChange: function(checked){
      this.destroyHiddenLayersFromList = checked;
    },
    _onSelectAllOnOpenChange: function(checked){
      this.selectAllOnOpen = checked;
    },
    ...
    _init: function() {
      ...
      this.destroyHiddenLayersFromList =this.config.destroyHiddenLayersFromList;
      this.destroyHiddenLayersFromListCheckBox.setValue(this.destroyHiddenLayersFromList);
      this.selectAllOnOpen =this.config.selectAllOnOpen;
      this.selectAllOnOpenCheckBox.setValue(this.selectAllOnOpen);
    ...
    getConfig: function() {
      return {
        ...
        destroyHiddenLayersFromList: this.destroyHiddenLayersFromList,
        selectAllOnOpen: this.selectAllOnOpen,
