  ...
  graphicsUtils, NlsStrings) {
    var clazz = declare([], {
      ...
      getDeniedItems: function () {
        ...
        } else if (this._layerInfo.baseMapLayer) {
          dynamicDeniedItems.push({
            'key': 'moveup',
            'denyType': 'hidden'
          });
        ...
        //RJS : deny zoom to basemaps
        if (this._layerInfo.baseMapLayer) {
          dynamicDeniedItems.push({
            'key': 'zoomto',
            'denyType': 'hidden'
          });
        ...
        // deny controlLabels
        if (!this._layerInfo.canShowLabel() || this._layerInfo.baseMapLayer) {
          dynamicDeniedItems.push({
            'key': 'controlLabels',
            'denyType': 'hidden'
          });
