        ...
        function (declare, lang, array, html, on, query, _WidgetsInTemplateMixin, BaseWidgetSetting, units, LinearUnit, Color, colors, easing,
                ...
                return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
                        ...
                        setConfig: function (config) {
                                ...
                                // GGO
                                this.maxSamples.set('value', config.maxSamples || 2000);
                                this.stepInitialValue.set('value', config.stepInitialValue || 1000);


                                //hack the 'Learn more about this widget link'
                                setTimeout(function () {
                                        var helpLink = query('.help-link');
                                        helpLink[0].href = 'http://gis.calhouncounty.org/WAB/V2.5/widgets/ElevationProfile/help/elevationprofile_Help.htm';
                                ...
                                // }
                                if (config.URLS.GeometryServer) {
                                        this.urlGeoTextBox.set('value', config.URLS.GeometryServer);
                                        this.urlGeoTextBox.proceedValue = true;
                                }

                                if (config.URLS.demUrl) {
                                        this.urlDemTextBox.set('value', config.URLS.demUrl);
                                        this.urlDemTextBox.proceedValue = true;
                                }
                        ...
                        getConfig: function () {
                                ...
                                var _maxSamples = this.maxSamples.get('value') || 2000;
                                var _stepInitialValue = this.stepInitialValue.get('value') || 1000;
                                var _tarkUrl = this.urlTextBox.get('value');
                                var _tarkGeoUrl = this.urlGeoTextBox.get('value');
                                var _demUrl = this.urlDemTextBox.get('value');
                                mConfig.vertexLimit = _maxSamples;
                                mConfig.form.dxNumberBoxStepValue.initalValue = _stepInitialValue;
                                // mConfig.profileTaskUrl = _tarkUrl; 
                                mConfig.URLS.GeometryServer = _tarkGeoUrl;
                                mConfig.URLS.demUrl = _demUrl;
                                console.log("GGO - getConfig");
                                console.log(mConfig);
